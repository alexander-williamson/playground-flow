...
//    {
//        private static FlowTemplate GetTemplate()
//        {
//            var template = new FlowTemplate { Id = 100, Name = "Example Flow" };
//            template.Variables.Add("Name", string.Empty);
//            template.Variables.Add("Age", null);
//            template.Steps = new List<StepBase>
//            {
//                new StartStep {Id = 0, MaximumNodes = int.MaxValue, MinimumNodes = 1, Name = "Start"},
...
//                new StopStep {Id = 5, MaximumNodes = int.MaxValue, MinimumNodes = 1, Name = "Stop"}
//            };
