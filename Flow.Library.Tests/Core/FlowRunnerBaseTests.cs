...
//            // assert
//            Assert.False(sut.CanProcess(typeof(CollectDataStep)));
//        }
...
//        {
//            // assemble
//            var fakeStep = A.Fake<IFlowTemplateStep>();
//            A.CallTo(() => fakeStep.IsComplete).ReturnsNextFromSequence(true);
//            var sut = new FlowRunner(new FlowInstance {Template = new FlowTemplate {Steps = new List<IFlowTemplateStep> {fakeStep}}});
