...
{
    public class CollectDataStep : StepBase
    {
        ...
        public CollectDataStep(List<IValidationRule> rules = null) //, Dictionary<string, object> requiredVariables = null)
        {
            ExitRules = rules ?? new List<IValidationRule>(); 
        }

        public CollectDataStep()
        {
